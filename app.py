...
app.layout = html.Div([
    ...
    dcc.Graph(
        figure={
          'data': [ # eine Liste von Linien erstellt, die als Dictionarys definiert sind.
             ...
             {'x': [2004, 2005, 2006, 2007, 2008,2009,2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019],
              'y': [70272, 71487, 76912, 81763, 81841, 82004, 79584, 78060, 74918, 71369, 68629, 67175, 65664, 65487, 64645, 65044],
